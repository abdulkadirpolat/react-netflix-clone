      ...
      <Navbar>
        <div className="w-full h-full flex flex-row items-center">
          ...
          <ul className="w-full flex">
            <li className="items-center ml-5 cursor-pointer mdmin-1:hidden flex text-white font-semibold ">
              Gözat <BiCaretDown className="ml-1" />{" "}
            </li>
            <li className="ml-5 cursor-default mdmin-1:flex hidden text-white font-semibold">
              Ana Sayfa
            </li>
            <li className="ml-5 cursor-pointer mdmin-1:flex hidden hover:text-nx-gray-200">
              Diziler
            </li>
            <li className="ml-5 cursor-pointer mdmin-1:flex hidden hover:text-nx-gray-200">
              Filmler
            ...
            <div className="account-menu relative cursor-pointer">
              ...
              >
                ...
                <ul className="h-auto px-0 py-3 w-full border-t border-solid border-white border-opacity-30 ">
                  <li className="py-1 px-3 hover:underline leading-4">Hesap</li>
                  <li className="py-1 px-3 hover:underline leading-4">
                    Yardım Merkezi
                  </li>
                  <Link to="/logout" className="py-1 px-3 hover:underline leading-4">
